...
use crate::asset::value::{AnyValue, ValueConfig, ValueDefault, ValueEntity, ValueEnum, ValueFaction, ValueGuid, ValueInt, ValuePrefab, ValueString, ValueVec3};
                ...
                match path.get_ident()?.to_string().as_str() {
                    "native" => {
                        ...
                        Ok(match id.as_str() {
                            ...
                            "Faction" => ValueFaction::def(),
                            "Config" => ValueConfig::def(),
                            "Prefab" => ValuePrefab::def(),
                            "Vec3" => ValueVec3::def(),
...
pub fn compile_native_call(tcx: TyCtxt, _span: Span, func: Instance, params: Vec<AnyValue>, ret: Option<AnyValue>) -> Option<Result<NodeKind>> {
